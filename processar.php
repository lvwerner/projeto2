...
$sexo_bebe = isset($_POST['sexo_bebe']) ? 'Masculino' : 'Feminino';
...
ficha_ocorrencia (
  oq_aconteceu,
  aconteceu_outros_vezes,
  tempo_aconteceu,
  possui_problema_saude,
  quais_doencas,
  faz_uso_medicacao,
  horario_ultima_medicacao,
  quais_medicacoes,
  alergico_alguma_coisa,
  especificacao_alergia,
  ingeriu_limento_liquido,
  horas_ingeriu,
  dia,
  sexo_paciente,
  nome_hospital,
  ...
  nome_bebe,
  causas_animais,
  causas_meio_transporte,
  causas_desmoronamento,
  causas_emergencia_medica,
  causas_queda_altura2m,
  causas_tentativa_suicidio,
  causas_queda_propria_altura,
  causas_afogamento,
  causas_agressao,
  causas_atropelamento,
  causas_choque_eletrico,
  causas_desabamento,
  causas_domestico,
  causas_esportivo,
  causas_intoxicacao,
  causas_queda_bicicleta,
  causas_queda_moto,
  causas_queda_nivel_2m,
  causas_trabalho,
  causas_transferencia,
  outras_causas,
  espontanea,
  comando_verbal,
  estimulo_doloroso,
  nenhuma,
  orientado,
  palavras_frase_apropriadas,
  conflito,
  palavras_inapropriadas,
  palavras_inapropriadas2,
  choro_persistente,
  palavras_incompreensiveis,
  sons_incompreensiveis,
  nenhuma_resposta_verbal,
  obedece_comandos,
  obedece_prontamente,
  localiza_dor,
  localiza_dor_ou_estimulo_tatil,
  movimento_de_retirada,
  retirada_do_segmento_estimulado,
  flexao_anormal,
  flexao_anormal2,
  extensao_anormal,
  extensao_anormal2,
  nenhuma_resposta_motora,
  ausencia,
  total_gcs_1,
  total_gcs_2,
  pressao_arterial1,
